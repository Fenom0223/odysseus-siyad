...
- **E2EE**: la sala se crea sin cifrado (invite-only en el Synapse propio). Para
  activarlo: `m.room.encryption` + `matrix-nio[e2e]` con `store_path`
  persistente (`NP_OFFICE_STATE_DIR` ya reservado).
